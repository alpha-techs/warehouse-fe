...
import type { InboundReport, Warehouse, Customer } from 'src/api/Api'
...
const downloadReport = async (report: InboundReport) => {
  ...
  try {
    ...
    const downloadUrl = useInboundStore().getInboundReportDownloadUrl(report.id)
        ...
        <q-card bordered>
          <q-card-section class="q-pa-none">
            ...
            >
              ...
              <template
                #[`body-cell-warehouse`]="{ row }: { row: InboundReport }"
              >
                <q-td>
                  <a
                    :href="
              ...
              <template
                #[`body-cell-customer`]="{ row }: { row: InboundReport }"
              >
                <q-td>
                  <a
                    :href="
              ...
              <template
                #[`body-cell-createdAt`]="{ row }: { row: InboundReport }"
              >
                <q-td>
                  {{
                    row.createdAt
              ...
              <template
                #[`body-cell-actions`]="{ row }: { row: InboundReport }"
              >
