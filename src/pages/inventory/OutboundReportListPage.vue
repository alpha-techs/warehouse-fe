                ...
                <q-card bordered>
                    <q-card-section class="q-pa-none">
                        <q-table flat :columns="columns" :rows="rows" row-key="id" hide-pagination
                            ...
                            <template #[`body-cell-warehouse`]="{ row }: { row: OutboundReport }">
                                <q-td>
                            ...
                            <template #[`body-cell-customer`]="{ row }: { row: OutboundReport }">
                                <q-td>
                                    <a :href="router.resolve({
                            ...
                            <template #[`body-cell-status`]="{ row }: { row: OutboundReport }">
                                <q-td>
                                    <q-badge :color="getStatusColor(row.status || '')"
                                        :label="getStatusLabel(row.status || '')" />
                                </q-td>
                            </template>
                            <template #[`body-cell-format`]="{ row }: { row: OutboundReport }">
                                <q-td>
                                    <q-chip :label="row.format?.toUpperCase()" dense />
                                </q-td>
                            </template>
                            <template #[`body-cell-createdAt`]="{ row }: { row: OutboundReport }">
                                <q-td>
                                    {{
                                        row.createdAt
                            ...
                            <template #[`body-cell-actions`]="{ row }: { row: OutboundReport }">
